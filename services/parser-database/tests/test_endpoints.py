...
def test_if_article_120_was_parsed(app, client):
    ...
    must_match = {
            'articleNumber': 120,
            'text': 'las escuelas deberán contar con lugares especiales y debidamente señalizados para que los vehículos de transporte escolar efectúen el ascenso y descenso de los escolares, sin que afecte u obstaculice la circulación en la vía pública. en caso de que el lugar de ascenso y descenso de escolares, ocasione conflictos viales, o ponga en riesgo la integridad física de los mismos, dichos lugares serán ubicados en las inmediaciones de los planteles donde técnicamente sea factible a propuesta de las escuelas y previa autorización de la autoridad municipal, observando de manera primordial lo necesario para garantizar la seguridad de los escolares.',
            'wordCount': 100
        }
